...
So these are two nodes that are connected to each other and they can share resources and can make conversation to each other.](image%201.png)
...
![  • Client Requesting for Resource or Service
  • Server provides that Resource or Service](image%205.png)

  • Client Requesting for Resource or Service
  • Server provides that Resource or Service

![However, Youtube doesn’t send the data all at once. It sends the stream of data until watched the whole vide.](image%206.png)
...
![Cisco Catalyst Switch](image%208.png)
...
![  • in Switch1 PC1, PC2, Printer, Desktop all are them connected through of Switch in a Local Area Network 
  ...
  • There are two different LAN.](image%209.png)
...
![Catalyst switches are cisco’s enterprise grade switches which used by enterprise level to connect their LAN’s](image%2011.png)
...
![Router is device which connects two different LAN’s. Two different LAN’s can be communicate through of each other via a Router.](image%2012.png)
...
![Enterprise grade cisco routers](image%2015.png)
...
![Firewall could be placed
  ...
  • Inside of network or LAN (FW2)](image%2016.png)
